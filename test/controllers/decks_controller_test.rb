...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { group_score: @deck.group_score, name: @deck.name, pilot: @deck.pilot, solo_score: @deck.solo_score } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { group_score: @deck.group_score, name: @deck.name, pilot: @deck.pilot, solo_score: @deck.solo_score } }
